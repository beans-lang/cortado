...
int32_t ctd_capability(int32_t capability) {
    switch (capability) {
        ...
        case CTD_CAP_LAYER_STYLE:   return 0;  /* A CSS box could do all three; nobody has written the cases yet. */
        ...
        /* All four exist on this platform and none of them is this toolkit:
           BlueZ, GeoClue, PipeWire and the portal API. A host that answered yes and
