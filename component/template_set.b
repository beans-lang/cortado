...
class TemplateInstance {
    ...
    closed: bool = false
    popup: bool
    pub fn init(owner: render.RenderObject, context: render.UiContext, view: ControlTemplate, popup: bool = false) {
        self.owner = owner; self.context = context; self.view = view
        self.popup = popup
        self.root = new widgets.Container(some(context))
...
/// Owns template mounts separately from the logical controls. No registry or
...
pub class TemplateSet {
    ...
    pub fn init(context: render.UiContext, factory: TemplateFactory) { self.context = context; self.factory = factory }
    pub fn refresh(root: widgets.Widget) -> Result<bool> {
        self.used = {}
        self.popup_used = {}
