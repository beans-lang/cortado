...
///
/// The output is a list of `Change`s, and the whole of cortado's rendering
...
pub class Differ {
    ...
    fn subscription(kind: ChangeKind, here: Path, event: events.EventKind) {
