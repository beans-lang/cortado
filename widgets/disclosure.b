...
pub class Disclosure extends ChildHolder {
    ...
    pub static fn of(title: string, open: bool) -> Result<Disclosure> {
        WidgetKind.disclosure.demand()?
        var twisty: Disclosure = new Disclosure()
    ...
    pub fn set_open(open: bool) -> Result<bool> {
        return self.set_flag(host.P_EXPANDED, open, "open or shut a disclosure")
    }

    pub fn is_open() -> Result<bool> {
        return self.read_flag(host.P_EXPANDED, "read whether a disclosure is open")
    }
}
